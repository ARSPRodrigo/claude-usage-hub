      ...
      <div className="hidden lg:flex lg:w-7/12 flex-col relative overflow-hidden bg-canvas">
        ...
        <div className="relative flex flex-col flex-1 px-16 py-14">
          <div className="flex items-center gap-2.5">
            ...
            <span className="label ml-1 px-1.5 py-0.5 rounded-pill" style={{ background: 'color-mix(in oklch, var(--accent) 12%, transparent)', color: 'var(--accent)' }}>v1.0</span>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-canvas-alt px-6 py-12 relative">
        ...
        <div className="w-full max-w-sm">
          <div className="bg-surface rounded-card border border-line p-8 shadow-popover">
            ...
            {error && (
              <div
                ...
                className="mb-5 p-3 rounded-btn text-sm text-neg"
                style={{ background: 'color-mix(in oklch, var(--neg) 8%, transparent)', border: '1px solid color-mix(in oklch, var(--neg) 20%, transparent)' }}
              >
                {error}
              </div>
            )}
            ...
            {passwordMode ? (
              <form onSubmit={handlePasswordLogin} data-testid="password-form" className="flex flex-col gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-btn border border-line bg-canvas text-sm text-ink placeholder-ink-4 focus:outline-none focus:ring-1 focus:ring-accent"
                ...
                <button
                  ...
                  type="submit"
                  disabled={loading}
                  className="mt-1 w-full py-2.5 rounded-btn bg-ink text-canvas text-sm font-medium disabled:opacity-50 hover:opacity-90 transition-opacity"
                >
          ...
          <p className="mt-5 text-center text-xs text-ink-4">
            {passwordMode
              ? 'Use the admin credentials configured at setup.'
